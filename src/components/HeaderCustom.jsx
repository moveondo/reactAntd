...
import ccdlogo from '../style/imgs/ccdlogo.png';
        ...
        return (
            <Header style={{ background: '#fff', padding: 0, height: 65 }} className="custom-theme" >
                ...
                >
                    ...
                    {/* <Menu.Item key="1">
                        <Badge count={250} overflowCount={100} style={{marginLeft: 10}}>
                            <Icon type="notification" />
                        </Badge>
                    </Menu.Item> */}
                    <SubMenu title={<span className="avatar"><img src={ccdlogo} alt="logo头像" /><i className="on bottom b-white" /></span>}>
