...
import read from '../components/project/read';
    ...
    render() {
        return (
            ...
            <Switch>
                ...
                <Route exact path="/app/project/create" component={create} />
                <Route exact path="/app/project/list" component={list} />
                <Route path="/app/project/list" component={list}>
                 {/* <Route path="/app/project/:topicId" component={filtering}/> */}
                </Route>
                <Route exact path="/app/project/filtering" component={filtering} />
                <Route exact path="/app/project/read" component={read} />
